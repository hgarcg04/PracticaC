...
int main()
{
   ...
   do
   {
        printf("Escriba 1 para calcular el volumen de un cono, escriba 2 para calcular el volumen de un ortoedro o 3 para salir del programa...\n");
        scanf("%f",&i);
        if((i!=1) && (i!=2) && (i!=3))
        {
            printf("Solo puedes poner o 1 o 2 o 3, no pongas cualquier otro número.\n");
        }
   }while((i!=1) && (i!=2) && (i!=3));
   if(i==1)
   {
